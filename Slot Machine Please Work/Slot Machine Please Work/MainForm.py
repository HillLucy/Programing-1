...
class MainForm(Form):
	...
	def InitializeComponent(self):
		...
		resources = System.Resources.ResourceManager("Slot_Machine_Please_Work.MainForm", System.Reflection.Assembly.GetEntryAssembly())
		...
		self._textBox1.Size = System.Drawing.Size(201, 35)
	...
	def Button1Click(self, sender, e):
		...
		if money == 0:
			...
			if num1 == 1 and num2 == 3 and num3 ==5:
				money2 += bet * 10
			
			if num1 == 4 and num2 == 5 and num3 == 1:
				money2 += bet * 5
				
			if num1 == 1 and num2 == 4 and num3 == 2:
				money2 += bet * 1.5
